...
public class Customer_login1 extends javax.swing.JFrame {

    public String user;
    public String pname,category,price,details,manufacturer;
    public Customer_login1() {
        initComponents();
        this.setLocationRelativeTo(null);
        
    }
    public Customer_login1(String para ){
        initComponents();
        id.setText(para);
        id.setVisible(false);
        user=id.getText();
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("Sofia Pro   Cond 6", 1, 30)); // NOI18N
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        String b=null,us,pw,check=null;
        ...
        try{
            ...
            if(pw.equals(b)){
                try{
                    ...
                    mystmt=myconn.createStatement();
                    myrs=mystmt.executeQuery("select *from products where ID="+"'"+user+"'");
                    while(myrs.next()){
                        pname = myrs.getString("Name");
                        category = myrs.getString("Category");
                        manufacturer = myrs.getString("Manufacturer");
                        price = myrs.getString("Price");
                        details = myrs.getString("Details");
                    }
                }
                catch (Exception exc) {
                    exc.printStackTrace();
                ...
                try{
                    ...
                    String sq1="select *from cart where Product_id="+"'"+user+"'";
                    mystmt=myconn.createStatement();
                    myrs=mystmt.executeQuery(sq1);
                    while(myrs.next()){
                        check=myrs.getString("Product_id");
                    }
                    if(user.equals(check)){
                         JOptionPane.showMessageDialog(null,"Already in your cart.");
                    }
                    else{
                        String sql="insert into cart"+"(customer_id,Product_id,Name,Category,Manufacturer,Price,Details)"+"values('"+us+"','"+user+"','"+pname+"','"+category+"','"+manufacturer+"','"+price+"','"+details+"')";
                    mystmt=myconn.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Customer_login1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Customer_login1().setVisible(true);
