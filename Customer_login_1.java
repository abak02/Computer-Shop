...
public class Customer_login_1 extends javax.swing.JFrame {

    public String user;
    public String check;
    public Customer_login_1() {
        initComponents();
        this.setLocationRelativeTo(null);
    }
    public Customer_login_1(String para ){
        initComponents();
        id.setText(para);
        id.setVisible(false);
        user=id.getText();
    ...
    private void btn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn1ActionPerformed
        String b=null,us,pw,name=null,category=null,manufacturer=null,price=null,details=null;
        ...
        try{
            ...
            if(pw.equals(b)){
                ...
                try{
                    ...
                    String sq1="select *from cart where Product_id="+"'"+user+"'"+"and customer_id="+"'"+us+"'";
                    mystmt=myconn.createStatement();
                    ...
                    if(user.equals(check)){
                        ...
                        String sql="insert into cart"+"(customer_id,Product_id,Name,Category,Manufacturer,Price,Details)"+"values('"+us+"','"+user+"','"+name+"','"+category+"','"+manufacturer+"','"+price+"','"+details+"')";
                    mystmt=myconn.createStatement();
